...
if [ $1 = 'start' ];then
    ...
    sudo cp -f EducationAdministrationSystem_server /etc/nginx/sites-available/EducationAdministrationSystem_server
    sudo ln -s -f /etc/nginx/sites-available/EducationAdministrationSystem_server /etc/nginx/sites-enabled/EducationAdministrationSystem_server
    sudo cp -f EducationAdministrationSystem.ini /etc/uwsgi/apps-available/
